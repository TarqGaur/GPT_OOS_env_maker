...
#     return addhistory(enhanced_prompt, True, "diognose", "diognose.json")
...
#     last_key2 = sorted(result2.keys(), key=int)[-1]
#     main_response2 = result1[last_key2]["llm"]["main_response"]
